...
<html lang="en">
  ...
  <div class="mb-3">
    <label for="building_number" class="form-label">Builiding Number</label>
    <input type="number" class="form-control" id="building_number" name="building_number" required>
  </div>
  <div class="mb-3">
    <label for="apartmenr_number" class="form-label">Apartment Number</label>
    <input type="number" class="form-control" id="apartmenr_number" name="apartmenr_number" required>
  </div>
  <div class="mb-3">
